export function Logo() {
  return (
    ...
    >
      <g filter="url(#filter0_dd_32001_307)">
        <g clipPath="url(#clip0_32001_307)">
          ...
          <rect
            ...
            height={32}
            rx={8}
            fill="url(#paint0_linear_32001_307)"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <path
            ...
            fill="#D0D5DD"
          />
          <g filter="url(#filter1_dd_32001_307)">
            <circle
              cx={19}
              cy={18}
              r={8}
              fill="url(#paint1_linear_32001_307)"
            />
          </g>
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_32001_307"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_32001_307"
            result="effect2_dropShadow_32001_307"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_32001_307"
            result="shape"
          />
        </filter>
        <filter
          id="filter1_dd_32001_307"
          x={8}
          y={8}
          width={22}
          height={22}
        ...
        <clipPath
          id="bgblur_1_32001_307_clip_path"
          transform="translate(2 -13)"
        >
          <path d="M3 18H35V21.2C35 25.6804 35 27.9206 34.1281 29.6319C33.3611 31.1372 32.1372 32.3611 30.6319 33.1281C28.9206 34 26.6804 34 22.2 34H15.8C11.3196 34 9.07937 34 7.36808 33.1281C5.86278 32.3611 4.63893 31.1372 3.87195 29.6319C3 27.9206 3 25.6804 3 21.2V18Z" />
        </clipPath>
        <linearGradient
          id="paint0_linear_32001_307"
          x1={19}
          y1={2}
          x2={19}
          y2={34}
