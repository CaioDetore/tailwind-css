  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      ...
      <div className="h-2 rounded-full bg-violet-100 dark:bg-zinc-600">
        <div className="h-2 w-1/2 rounded-full bg-violet-600 dark:bg-violet-400" />
      </div>

      <div className="space-x-3">
        <button
          type="button"
          className="text-sm font-medium text-violet-500 duration-200 hover:text-violet-700 dark:text-violet-300 dark:hover:text-zinc-200"
        >
          Dismiss
        </button>
        ...
        <button
          type="button"
          className="hover:text-violet-70 text-sm font-medium text-violet-500 duration-200 dark:text-violet-300 dark:hover:text-zinc-200"
        >
          Upgrade plan
        </button>
      </div>
