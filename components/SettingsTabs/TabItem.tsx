...
export function TabItem({ isSelected = false, title, value }: Props) {
  return (
    <Tabs.Trigger
      value={value}
    ...
    >
      <span className="rounded-full whitespace-nowrap group-focus-visible:ring-2 group-focus-visible:ring-violet-400 group-focus-visible:ring-offset-4">
        {title}
      </span>
